...
public class AddHasResearchAreaCommand extends Command {
    ...
    public AddHasResearchAreaCommand(String login, String passwd, ResourceToResource resourceToLink, String MINE_TYPE) {
        super();
    ...
    public CommandResult execute(Receiver vivo) {
        try {
            result = ((VivoReceiver)vivo).addPersonHasResearchArea(login, passwd, resourceToLink, MINE_TYPE);
	...
	public String toString() {
		return "AddHasResearchAreaCommand [resourceToLink=" + resourceToLink + "]";
	}
