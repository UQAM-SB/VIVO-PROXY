...
${BOLD}${WHITE}VIVO Proxy API command line client (API version 1.0.0)${OFF}
...
read -r -d '' ops <<EOF
  ${CYAN}createOrganization${OFF};Create an organization in VIVO (AUTH)
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
echo "  $ops" | column -t -s ';'
    echo ""
    echo -e "${BOLD}${WHITE}[vivo]${OFF}"
read -r -d '' ops <<EOF
  ${CYAN}getindividualByIRI${OFF};Get an individual by IRI (AUTH)
EOF
echo "  $ops" | column -t -s ';'
    echo ""
...
echo -e "              \\t\\t\\t\\t(e.g. 'https://localhost:9090')"
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}VIVO Proxy API command line client (API version 1.0.0)${OFF}"
    echo ""
    echo -e "License: Apache 2.0"
    echo -e "Contact: vivo@uqam.ca"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}VIVO Proxy API command line client (API version 1.0.0)${OFF}"
    echo ""
}

##############################################################################
#
# Print help for createOrganization operation
#
##############################################################################
print_createOrganization_help() {
    echo ""
    echo -e "${BOLD}${WHITE}createOrganization - Create an organization in VIVO${OFF}${BLUE}(AUTH - BASIC)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "This can only be done by the logged in VIVO." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[]${OFF} ${RED}(required)${OFF}${OFF} - Created organization object" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
    echo -e "${result_color_table[${code:0:1}]}  200;OK (successfully authenticated)${OFF}" | paste -sd' ' | column -t -s ';' | fold -sw 80 | sed '2,$s/^/       /'
    code=401
...
##############################################################################
#
# Print help for createPerson operation
#
##############################################################################
print_createPerson_help() {
    echo ""
    echo -e "${BOLD}${WHITE}createPerson - Create a person in VIVO${OFF}${BLUE}(AUTH - BASIC)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "This can only be done by the logged in person." | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}body${OFF} ${BLUE}[]${OFF} ${RED}(required)${OFF}${OFF} - Created person object" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo ""
    echo -e "${BOLD}${WHITE}Responses${OFF}"
    code=200
...
##############################################################################
#
# Print help for getindividualByIRI operation
#
##############################################################################
print_getindividualByIRI_help() {
    echo ""
    echo -e "${BOLD}${WHITE}getindividualByIRI - Get an individual by IRI${OFF}${BLUE}(AUTH - BASIC)${OFF}" | paste -sd' ' | fold -sw 80 | sed '2,$s/^/    /'
    echo -e ""
    echo -e "" | paste -sd' ' | fold -sw 80
    echo -e ""
    echo -e "${BOLD}${WHITE}Parameters${OFF}"
    echo -e "  * ${GREEN}IRI${OFF} ${BLUE}[string]${OFF} ${RED}(required)${OFF}${OFF} - Used to obtain information from a VIVO individual by the IRI${YELLOW} Specify as: IRI=value${OFF}" \
...
##############################################################################
#
# Call createOrganization operation
#
##############################################################################
call_createOrganization() {
    ...
    if ! path=$(build_request_path "/vivoproxy/organization" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="POST"
...
call_getindividualByIRI() {
    ...
    if ! path=$(build_request_path "/vivoproxy/vivo" path_parameter_names query_parameter_names); then
        ERROR_MSG=$path
        exit 1
    fi
    local method="GET"
