...
public class DocumentApi {
     ...
     */
    public com.squareup.okhttp.Call createDocumentCall(Document body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createDocumentValidateBeforeCall(Document body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    /**
     * Create a document in VIVO (asynchronously)
     * This can only be done by the logged in person.
     * @param body Created a document (required)
    ...
    /**
     * Build call for documentAddAuthorFor
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call documentAddAuthorForCall(AuthorOfADocument body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/document/addAuthorFor";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call documentAddAuthorForValidateBeforeCall(AuthorOfADocument body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling documentAddAuthorFor(Async)");
        }
        
        com.squareup.okhttp.Call call = documentAddAuthorForCall(body, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Associate a document to an Author (asynchronously)
     * 
     * @param body Author that need to be add to a document (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
