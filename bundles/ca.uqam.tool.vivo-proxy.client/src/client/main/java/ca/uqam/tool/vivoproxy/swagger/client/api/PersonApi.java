...
public class PersonApi {
    ...
    /**
     * Build call for createPersonWithEmail
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createPersonWithEmailCall(PersonWithOfficeInfo body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/person/createWithEmailHasKey";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createPersonWithEmailValidateBeforeCall(PersonWithOfficeInfo body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createPersonWithEmail(Async)");
        }
        
        com.squareup.okhttp.Call call = createPersonWithEmailCall(body, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Create a user in VIVO using the eMail address as an IRI key (asynchronously)
     * This can only be done by the logged in person.
     * @param body Created person object with email (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for personAddDocument
     * @param body Author of document (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call personAddDocumentCall(AuthorOfADocument body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/person/addDocument";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call personAddDocumentValidateBeforeCall(AuthorOfADocument body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling personAddDocument(Async)");
        }
        
        com.squareup.okhttp.Call call = personAddDocumentCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String personAddDocument(AuthorOfADocument body) throws ApiException {
        ApiResponse<String> resp = personAddDocumentWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> personAddDocumentWithHttpInfo(AuthorOfADocument body) throws ApiException {
        com.squareup.okhttp.Call call = personAddDocumentValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Associate a Document to a Person (asynchronously)
     * 
     * @param body Author of document (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call personAddDocumentAsync(AuthorOfADocument body, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = personAddDocumentValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
